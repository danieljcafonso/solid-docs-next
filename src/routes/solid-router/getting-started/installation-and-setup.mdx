...
The [`Router`](/reference/solid-router/components/router) component is the root component of the router.
It is responsible for managing the URL and rendering the appropriate [`Route`](/reference/solid-router/components/route) based on the URL.
